...
<body>
        <div class="container">
            ...
            <div class="dropdown-content">
                ...
                <a href="mackbook-pro.php">MacBook Pro</a>
                <!-- <a href="#">iMac</a>
                <a href="#">iMac Pro</a>
                <a href="#">Mac Pro</a>
                <a href="#">Mac mini</a> -->
...
?>
        ...
        <?php
          include ("card-macbook-pro.php");
                include ("db_connection.php");   // altijd eerst deze regel toevoegen om een connectie met je db te maken //
                    $sql = "SELECT *  FROM category where category_name = 'macbook-pro'";  //slecteer alles van de tabel product waar de product naam gelijk is aan macbook //
