...
?>
        ...
        <?php
         include ("card-macbook-air.php");
                include ("db_connection.php");   // altijd eerst deze regel toevoegen om een connectie met je db te maken //
                    $sql = "SELECT *  FROM category where category_name = 'macbook-air'";  //slecteer alles van de tabel product waar de product naam gelijk is aan macbook //
